...
function AboutUs() {
  return (
    <div
      className="h-screen md:h-full md:bg-cover bg-auto"
      style={{ backgroundImage: `url(${bg_aboutus})` }}
    >
      <div
        className="flex flex-col justify-start bg-contain md:bg-auto"
        style={{
          // Conditionally render background image based on screen size
          backgroundImage: `url(${
            window.innerWidth <= 768 ? football_mobile : football
          })`,
      ...
      >
        ...
        <div className="ml-6 mt-4 text-white">
          <h1 className="text-4xl md:text-7xl font-medium text-shadow-orange-stroke  font-Rampart">
            ABOUT US
          </h1>
        </div>
        <div className="w-screen flex flex-col mb-[7%]">
          <img
            src={desc}
            alt="desc"
            className="ml-[-2] mt-2 w-[80%] h-[80%] md:w-[35%] md:h-[35%]"
          />
          <br></br>
          <div className="items-end">
            <SimpleSlider className="items-end" />
          </div>
        </div>
      </div>
      <br></br>
