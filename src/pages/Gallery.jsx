  ...
  function Gallery() {
    return (
      <div className="max-md:overflow-y-hidden h-screen bg-[#F7A23F] flex justify-center flex-col max-md:items-center" style={{ backgroundImage: `url(${bgimg})`, backgroundSize: 'cover', height:'95vh' }}>
