  ...
  function Gallery() {
    return (
      <div className="min-h-screen bg-[#F7A23F] flex justify-center flex-col max-md:items-center" style={{ backgroundImage: `url(${bgimg})`, backgroundSize: 'cover', height:'100vh' }}>
